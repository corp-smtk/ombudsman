...
const DetailKegiatan = () => {
    ...
    if (!myparam) return <Redirect to="/pencatatan" />
    ...
    return (
        <div className='main-animation'>
            <div className="d-flex flex-row justify-content-between align-items-center">
                <div>
                    <Link className="content-link" to={{ pathname: `/pencatatan` }}><h3 className="content-title"><FontAwesomeIcon icon={faArrowLeft} size="sm" />&nbsp; Detail Kegiatan</h3></Link>
                </div>
            </div>
